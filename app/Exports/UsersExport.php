...
class UsersExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    */
    public function collection()
    {
        ...
        ->select('users.id_tipo_identificacion', 'ti.sigla', 'users.id', 'users.id_role', 'roles.role', 'users.id_categoria', 'cat.categoria',
    ...
    public function headings():array
    {
        return['ID TI', 'TI', 'IDENTIFICACION', 'ID ROL', 'ROL', 
               'ID CATEGORIA', 'CATEGORIA', 'ID ESTADO', 'ESTADO', 'ID ESP. ACAD 1',
