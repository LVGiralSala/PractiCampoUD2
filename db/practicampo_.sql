...
-- Volcando datos para la tabla practicampoud.espacio_academico: ~135 rows (aproximadamente)
...
-- Volcando datos para la tabla practicampoud.proyeccion_preliminar: ~0 rows (aproximadamente)
