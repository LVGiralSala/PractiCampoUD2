...
-- Volcando datos para la tabla practicampo.espacio_academico: ~30 rows (aproximadamente)
/*!40000 ALTER TABLE `espacio_academico` DISABLE KEYS */;
REPLACE INTO `espacio_academico` (`id`, `espacio_academico`, `tipo_espacio`) VALUES
	(2111, 'Biología general ', NULL),
	(2115, 'Botánica taxonómica ', NULL),
	(2148, 'Aprovechamiento forestal ', NULL),
	(2170, 'Biología de la conservación ', NULL),
	(2175, 'Áreas protegidas  ', NULL),
	(2325, 'Administración municipal y desarrollo local', NULL),
	(2403, 'Introducción a la administración ambiental', NULL),
	(2413, 'Organizaciones comunitarias', NULL),
	(2418, 'Problemas y alternativas ambientales', NULL),
	(2429, 'Factores de riesgo ambiental en salud pública', NULL),
	(2434, 'Vulnerabilidad y riesgos', NULL),
	(2443, 'Administración de recursos naturales', NULL),
	(2534, 'Administración municipal', NULL),
	(2703, 'Introducción a la ingeniería ambiental', NULL),
	(2716, 'Geología y geomorfología', NULL),
	(2720, 'Suelos', NULL),
	(2724, 'Química ambiental aplicada', NULL),
	(2726, 'Hidrología', NULL),
	(2727, 'Ecología analítica', NULL),
	(2728, 'Contaminación ambiental II', NULL),
	(2730, 'Fisicoquímica de fluidos', NULL),
	(2733, 'Ordenamiento territorial rural', NULL),
	(2734, 'Contaminación ambiental II', NULL),
	(2735, 'Tecnologías apropiadas I', NULL),
	(2736, 'Hidrogeología', NULL),
	(2739, 'Tecnologías apropiadas II', NULL),
	(2742, 'Evaluación ambiental I', NULL),
	(2743, 'Manejo técnico ambiental', NULL),
	(2746, 'Evaluación ambiental II', NULL),
	(11810, 'Acueductos', NULL);
...
CREATE TABLE IF NOT EXISTS `proyeccion_preliminar` (
  ...
  `exclusiv_tiempo_ra_3` tinyint(1) DEFAULT NULL,
  `aprobacion_coordinador` tinyint(1) DEFAULT NULL,
  `aprobacion_decano` tinyint(1) DEFAULT NULL,
...
-- Volcando datos para la tabla practicampo.users: ~9 rows (aproximadamente)
...
REPLACE INTO `users` (`id`, `id_role`, `id_tipo_identificacion`, `id_tipo_vinculacion`, `id_estado`, `id_espacio_academico_1`, `id_espacio_academico_2`, `id_espacio_academico_3`, `id_espacio_academico_4`, `id_espacio_academico_5`, `id_espacio_academico_6`, `usuario`, `primer_nombre`, `segundo_nombre`, `primer_apellido`, `segundo_apellido`, `celular`, `telefono`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 4, 2, 2111, 2148, NULL, NULL, NULL, NULL, 'LV32', 'Luisa', NULL, 'Garcia', 'Lopez', 3195693569, NULL, 'Lvgiraldos@gmail.com', NULL, '$2y$10$uFngpVjfCVSw.vk6DtcLqOs8Y0z7ViO3VZdDIQtw2GJAa56fsoz3G', '55QPeKoNPJ41WkvHHpFbax5bMIaGHnZG9ib1UeAVEibGe8iOdzHvB4IIhRlZ', '2020-01-17 01:40:42', '2020-02-17 03:18:50'),
	(8652348, 5, 1, 1, 1, 2434, NULL, NULL, NULL, NULL, NULL, 'criverag', 'Cesar', NULL, 'Rivera', 'Gomez', 3015698745, 5684512, 'criverag@udistrital.edu.co', NULL, '$2y$10$Er4bk9.yD9pFnKrKOyzGB.Erwrd4XFHCUkNR5/90HHdyNQo8C6.iW', NULL, '2020-02-27 02:52:29', '2020-02-27 02:52:29'),
	(30314801, 5, 1, 1, 1, 2434, 2115, NULL, NULL, NULL, NULL, 'emontesr', 'Emilia', NULL, 'Montes', 'Rojas', 3154269895, 7289645, 'lauritagiraldo.s@gmail.com.co', NULL, '$2y$10$JyWtQxOKKx9W2eWBn2yCduyRCcSU4W5YF6gErdNfeJ6B.Ti.Gl1S6', NULL, '2020-02-27 02:52:56', '2020-02-27 02:52:56'),
	(30569841, 4, 1, 1, 1, 2434, NULL, NULL, NULL, NULL, NULL, 'jposadam', 'Jairo', NULL, 'Posada', 'Martinez', 3152695487, 3216956, 'jposadam@udistrital.edu.co', NULL, '$2y$10$ZNaeSKLtN/17lX6SVEmP2.TetVJQuvjBQTR93LLyat6B1VpuXOuI.', NULL, '2020-02-27 02:53:02', '2020-02-27 02:53:02'),
	(32589654, 6, 3, 1, 2, 2175, 2733, 2325, 2703, NULL, NULL, 'pyepes', 'Paula', NULL, 'Yepes', NULL, 3217896532, 55555, 'pyepes@gmail.com', NULL, '$2y$10$3BtjxquKd6O8E13ju99pouzAVl71w1WV0aN/1G/BtCoiNVLb4I2B2', NULL, '2020-02-26 22:03:46', '2020-03-02 19:13:43'),
	(85365213, 7, 1, 1, 1, 2434, NULL, 2726, NULL, NULL, NULL, 'andresquintero', 'Andres', 'Luis', 'Quintero', 'Zuluaga', 3152369563, 5489632, 'andresquintero@gmail.com', NULL, '$2y$10$.7bcv00FImy3IFmfDViVguZsHw8CfvDTW4fZoEtdT4FF.QA3kUmy2', NULL, '2020-02-27 02:56:39', '2020-02-27 02:56:39'),
	...
	(1038410523, 1, 1, 1, 1, 2746, 2434, 2743, 2115, 2728, 2733, 'lvgiraldos', 'Laura', 'Vanessa', 'Giraldo', 'Salazar', 3107964434, 4125679, 'lvgiraldos@udistrital.edu.co', NULL, '$2y$10$V/4DkEVqMJNNXiHyUY42sOqTSRHtfhJAoOViAeoVxzbFwvj72ELg.', NULL, '2020-02-16 23:34:35', '2020-02-16 23:34:35');
