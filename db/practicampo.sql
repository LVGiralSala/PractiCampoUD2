...
CREATE TABLE IF NOT EXISTS `proyeccion_preliminar` (
  ...
  `vlr_materiales_rp` varchar(50) DEFAULT NULL,
  `vlr_materiales_ra` varchar(50) DEFAULT NULL,
...
-- Volcando datos para la tabla practicampo.proyeccion_preliminar: ~7 rows (aproximadamente)
