...
{{-- <body>
    ...
    <br>
    <p>La proyección preliminar N°<php ?> ha sido aprobada por coordinación y remitida a las áreas de vicerrectoría administrativa y financiera para presentación y aprobación.</p>
    <br>
    <p>Ingrese al sistema para hacer seguimiento.</p>
    <ul>
        <li>Nombre: Troglodita Mayor</li>
        <li>Teléfono: 9982666</li>
        <li>CODIGO: 555-666</li>
        <h3>prueba apertura_proy</h3>
    </ul>
    <p>Y esta es la posición reportada:</p>
    <ul>
        
            <a href="https://www.google.com/maps/place/Parque+P%C3%BAblico+El+Sol/@4.6139741,-74.1155073,14z/data=!4m8!1m2!2m1!1sparque+el+sol!3m4!1s0x8e3f994edb99dc4d:0x963ae0033b534eb4!8m2!3d4.6139741!4d-74.1155073">
                Ver en Google Maps
            </a>
        </li>
    </ul>
...
<body>
    <p>Aprobación Coordinación - Proyección Preliminar N°<?php ?></p>
    <br>
    ...
    @endif
    @if(Auth::user()->decano())
    <p>La proyección preliminar N°<?php ?> ha sido aprobada por coordinación para la consolidación en el plan de prácticas y </p>
    <p>presentación del plan de contratación a las áreas de vicerrectoría administrativa y financiera.</p>
    <br>
    @endif
...
<body>
    ...
    <br>
    @if(Auth::user()->docente())
    <p>La solicitud de práctica N°<?php ?> ha sido aprobada por coordinación, remitida al Consejo de Factuldad para el</p>
    <p>debido trámite.</p>
    <br>
    @endif
    @if(Auth::user()->decano())
