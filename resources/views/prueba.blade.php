...
<head>
	...
	<style>
	#header { position: fixed; left: 0px; top: -32px; right: 0px; height: 200px; background-color: orange; text-align: center; }
	...
	{{-- <div class="container">
			...
			<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
				<div class="row" id="header">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
						<img src="{{asset('img/logo_ud_2.png')}}" alt="" style="width:30%;position:center;">
					</div>
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3"></div>
				</div>
				<div class="row">
					<h6>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officia veniam 
						suscipit est sequi impedit beatae incidunt totam ipsa, deserunt quae 
						voluptatum atque laborum nemo ex blanditiis, architecto dolor facilis temporibus?
		...
		<div class="WordSection1 margenGral">
			...
			<p class="margenParrCent" align="center"><b style="mso-bidi-font-weight:normal">
				...
				NÚMERO 0071 DE 2020<o:p></o:p></span></b>
			</p>
			...
			<p class="margenParrJust">
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">El
				Decano de la Facultad del Medio Ambiente y Recursos Naturales de la Universidad
			...
			<p class="margenParrJust">
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">Que
				en virtud de las Resoluciones No. 009 del 15 de enero de 2020 el señor Rector
				de la Universidad Distrital Francisco José de Caldas delega en el Decano de la
				Facultad de Medio Ambiente y Recursos Naturales la ordenación del gasto y la
				contratación para el rubro de Practicas Académicas Facultad del Medio Ambiente.<o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust">
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">Que
				mediante Resolución del Consejo Superior Universitario No. 004 del 4 de
				marzo<span style="mso-spacerun:yes">&nbsp; </span>de 2003, se establecen las escalas
				salariales de las distintas categorías de empleos<span style="mso-spacerun:yes">&nbsp; </span>de la Universidad Distrital Francisco José de
				Caldas y se dictan otras disposiciones. <o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust">
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">Que en
				el artículo cuarto de la Resolución de la Rectoría No. 311 del 25 de junio de
				2019, se establece que: “para la realización de prácticas académicas, a los
				docentes de carrera y de vinculación especial, sólo se les podrán reconocer
				viáticos, a 31 de diciembre de 2003, hasta por el valor de SESENTA Y CINCO MIL
				PESOS ($65.000) MC/TE por día pernoctado. Dicha suma, se reajustará anualmente
				en un porcentaje igual al incremento del índice de Precios al Consumidor
				(1.P.C.) Nacional, que registre el DANE a 31 de diciembre de cada <o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust">
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">Que
				mediante Resolución de Rectoría No. 311 del 25 de junio de 2019, se reglamenta
				el procedimiento general de solicitud de los avances, aprobación, desembolso y
				su correspondiente legalización en la Universidad.<o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust">
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">Que
				en el artículo tercero de la Resolución de Rectoría No. 311 del 25 de junio de
				2019, se establecen las modalidades de avances.<o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust" style="mso-layout-grid-align:none;text-autospace:none">
				<span style="font-size:9.0pt;font-family:&quot;Arial&quot;,sans-serif" lang="ES">Que en el artículo primero del Acuerdo 012 del 24 de
				octubre de 2019 el Consejo Superior modificó el Artículo del Acuerdo No. 010 de
				1988, en el cual determinó que </span><i>
				<span style="font-size:9.0pt;mso-fareast-font-family:Calibri;mso-ansi-language:ES-CO">"ARTÍCULO 2°. Los
				estudiantes que deban realizar prácticas académicas fuera de la ciudad de
				Bogotá en el territorio Nacional, según la normatividad interna, recibirán un
				auxilio económico equivalente al valor de uno punto dos (1.2) Salarios Mínimos
				Diarios Legales Mensuales Vigentes —SMDLV, cuando la práctica sea por un solo
				día.<o:p></o:p></span></i>
			</p>
			
			<p class="margenParrJust"><i>
				<span style="font-size:9.0pt;mso-fareast-font-family:Calibri;mso-ansi-language:ES-CO">En el caso que las prácticas sean por dos (2)
				o más días, los estudiantes recibirán un auxilio económico equivalente al valor
				de uno punto ocho 0.8) Salarios Mínimos Diarios Legales Mensuales Vigentes
				—SMDLV, por cada uno de los días de práctica académica"</span></i>
			...
			<p class="margenParrJust">
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">Que
				se hace necesario autorizar el trámite de un avance a la División Financiera de
				la Universidad Distrital Francisco José de Caldas, y así mismo el manejo y
				ejecución del mismo a un docente de</span><span style="font-size:10.0pt;
				line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES"> </span><span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">la
				Universidad, para la financiación de los gastos generados por el desarrollo de
				una actividad académica.<o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust" >
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">Que
				los planes de prácticas de los diferentes Proyectos Curriculares adscritos a la
				Facultad del Medio Ambiente y Recursos Naturales se aprobaron por el Consejo de
				Facultad mediante sesión del 15 de mayo Acta No 009 de 2019. <o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust"><b style="mso-bidi-font-weight:normal">
				...
				Autorizar el trámite y pago de un avance a nombre del (la) docente <b style="mso-bidi-font-weight:normal">MARTHA ISABEL MEJIA DE ALBA </b>identificado(a)
				con cédula de ciudadanía No.22.807.498 para cubrir los gastos de la práctica
				académica del Proyecto Curricular Ingeniería Ambiental del presupuesto descrito
				en el siguiente cuadro, con Disponibilidad Presupuestal 1456</span>
			...
			<p class="margenParrJust">
				<span style="font-size:9.0pt;font-family:&quot;Arial&quot;,sans-serif" lang="ES">** El viático de
				cada docente es de $ 135.400 * (el número de días – 0.5)<o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust" style="text-indent:0cm;mso-list:l0 level1 lfo2;tab-stops:list 36.0pt"><!--[if !supportLists]-->
				...
				<span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;</span>El auxilio de cada estudiante es de $35.100
				para prácticas de un día cuyo destino es fuera de la ciudad de Bogotá<o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust" style="text-indent:0cm;mso-list:l0 level1 lfo2;tab-stops:list 36.0pt"><!--[if !supportLists]-->
				...
				<span style="font-size:9.0pt;font-family:&quot;Arial&quot;,sans-serif" lang="ES"><span style="mso-spacerun:yes">&nbsp;&nbsp;&nbsp;&nbsp;</span>El auxilio de cada estudiante es de $52.600
				diario para prácticas de más de un día cuyo destino es fuera de la ciudad de
				Bogotá<o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust"><b style="mso-bidi-font-weight:normal">
				...
				<span style="color:black">Que el Decano de la Facultad del Medio Ambiente y
				Recursos Naturales en uso de sus facultades legales y especialmente las
				contempladas en el Articulo 91 del Acuerdo 11 de 2002, literal e,<span style="mso-spacerun:yes">&nbsp; </span>concede comisión para adelantar actividades
				relacionadas con su actividad académica al (los) docente (es) que participara(n)
				en la(s) practica(s) académica(s) descrita es este acto administrativo</span><o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust"><b style="mso-bidi-font-weight:normal">
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">ARTICULO TERCERO:</span></b><span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">
				Delegar al citado docente para el manejo y legalización de los recursos
				entregados<o:p></o:p></span>
			</p>
			...
			<p class="margenParrJust"><b style="mso-bidi-font-weight:normal">
				...
				<span style="font-size:9.0pt;line-height:115%;font-family:&quot;Arial&quot;,sans-serif" lang="ES">:
				La presente Resolución rige a partir de la de fecha de su expedición.<o:p></o:p></span>
			</p>
			...
			Ambiente y Recursos Naturales a los cuatro (4) días del mes de marzo de 2020.<o:p></o:p></span></p>
			...
			<p class="margenParrCent" align="center"><b style="mso-bidi-font-weight:normal">
				<span style="font-size:9.0pt;font-family:&quot;Arial&quot;,sans-serif" lang="ES">JAIME EDDY USSA GARZON<o:p></o:p></span></b>
			</p>
